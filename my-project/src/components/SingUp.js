    ...
    render() {
        return (<>
            ...
            <div className="sectionLogin">
                ...
                <div><input type="text" placeholder="Full name" className="loginFullName textLogin"></input></div>
                ...
                <button className="buttonLogin">Sing up</button>
                <p className="fogetInput">Already have an account? <span className="blueSing">Sign In</span> </p>
            </div>
        </>)
    }
}
